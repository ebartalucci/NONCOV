...
#
# *********************************************** DESCRIPTION *****************************************************
# Perform Natural Bonding Orbital and Atom In Molecule analysis for each of the xyz files in the folder
#
# Use same Level of Theory as for geometry optimization
# 
# 
...
nbo_aim_method="r2scan-3c def2-mTZVPP def2/J D4 NBO AIM NOAUTOSTART"
multijob_inp="aa_nbo_aim"  		        # Output file for geometry optimization jobs
newj=New_Step
endj=Step_End
